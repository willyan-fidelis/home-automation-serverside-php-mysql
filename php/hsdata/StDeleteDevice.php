...
//http://localhost/hsn_db/php/hsdata/StDeleteDevice.php/?email=teste@gmail&session=120633a8a8cd5840884e66196d6ec535&number=ChipID:12345
...
if ($sp_result["Result"] == 1)
{
	...
	$sp_result = $DataExchange->ExecuteSPWithDataSet(true, "StDeleteDevice", array("Number"), array("s", "s", "i"), array("Email", "Number", "Result"), array($data["email"], $data["number"], 0), array("Result"));
}
else
{
