...
//http://localhost/hsn_db/php/hsdata/SpEditUserPwd.php/?email=teste@gmail&session=120633a8a8cd5840884e66196d6ec535&newpwd=555&pwd=123
...
if ($sp_result["Result"] == 1)
{
	...
	$sp_result = $DataExchange->ExecuteSPWithDataSet(true, "SpEditUserPwd", array("NewPassword"), array("s", "s", "s", "i"), array("Email", "NewPwd", "OldPwd", "Result"), array($data["email"], $data["newpwd"], $data["pwd"], 0), array("Result"));
}
else
{
