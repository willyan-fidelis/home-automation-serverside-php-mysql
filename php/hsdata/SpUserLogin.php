...
//http://localhost/hsn_db/php/hsdata/SpUserLogin.php/?email=teste@gmail&pwd=123
...
if (true)//if ($sp_result["Result"] == 1)
{
	...
	$sp_result = $DataExchange->ExecuteSPWithDataSet(true, "SpUserLogin", array("Session"), array("s", "s", "i"), array("Email", "Pwd", "Result"), array($data["email"], $data["pwd"], 0), array("Result"));
}
else
{
