...
//http://localhost/hsn_db/php/hsdata/SpUserRoomAdd.php/?email=teste@gmail&session=95e1da2eaee0f330beeead69388a1947&room_name=Jardim&RoomType=room
...
if ($sp_result["Result"] == 1)
{
	...
	$sp_result = $DataExchange->ExecuteSPWithDataSet(true, "SpUserRoomAdd", array("Email"), array("s", "s", "s", "i"), array("Email", "Room", "RoomType", "Result"), array($data["email"], $data["room_name"], $data["RoomType"], 0), array("Result"));
}
else
{
