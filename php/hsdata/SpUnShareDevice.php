...
//http://localhost/hsn_db/php/hsdata/SpUnShareDevice.php/?emailToUnShare=abc@gmail&email=teste@gmail&session=73971094557b6cfb78e80dea96b34581&number=20161220.001.16668185&rights=1
...
if ($sp_result["Result"] == 1)
{
	...
	$sp_result = $DataExchange->ExecuteSPWithDataSet(true, "SpUnShareDevice", array("Select_Result"), array("s", "s", "s", "i"), array("UserEmailToBeUnShared", "Email", "Number", "Result"), array($data["emailToUnShare"], $data["email"], $data["number"], 0), array("Result"));
}
else
{
