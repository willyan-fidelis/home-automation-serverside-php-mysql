...
//http://localhost/hsn_db/php/hsdata/StReturnModuleList.php/?email=teste@gmail&session=30faf8622606f0de332560dc4e9b2ed3
...
if ($sp_result["Result"] == 1)
{
	...
	$sp_result = $DataExchange->ExecuteSPWithDataSet(true, "StReturnModuleList", array("OID", "TDevice_OID", "Name", "Favorite", "Desactvated", "Position", "ParentPosition", "Number"), array("s", "i"), array("InParm", "Result"), array($data["email"], 0), array("Result"));
}
else
{
