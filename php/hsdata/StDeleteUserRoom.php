...
//http://localhost/hsn_db/php/hsdata/StDeleteUserRoom.php/?email=teste@gmail&session=95e1da2eaee0f330beeead69388a1947&room_name=Jardim
...
if ($sp_result["Result"] == 1)
{
	...
	$sp_result = $DataExchange->ExecuteSPWithDataSet(true, "StDeleteUserRoom", array("Email"), array("s", "s", "i"), array("Email", "Room", "Result"), array($data["email"], $data["room_name"], 0), array("Result"));
}
else
{
